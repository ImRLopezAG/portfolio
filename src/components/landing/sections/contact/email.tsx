...
export const ContactFormEmail = ({ name, message }: ContactFormEmailProps) => {
	return (
		<Html>
			<Head />
			<Preview>
			...
			<Body className='bg-gray-10 font-sans'>
				<Container className='my-10 max-w-[600px]'>
					...
					<Section className='rounded-b-lg border border-gray-200 border-t-0 bg-white px-8 py-10 shadow-lg'>
						...
						<Section className='my-8 rounded-xl border border-gray-200 bg-linear-to-br from-gray-50 to-white p-8 shadow-sm'>
							<Heading
								as='h3'
