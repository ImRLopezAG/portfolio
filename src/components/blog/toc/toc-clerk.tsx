...
function TOCItem({
  ...
  return (
    <Primitive.TOCItem
      ...
      className="prose relative py-1.5 text-sm text-muted-foreground transition-colors [overflow-wrap:anywhere] first:pt-0 last:pb-0 data-[active=true]:text-blue-400"
    >
      {offset !== upperOffset ? (
        <svg
